...
VL_INLINE_OPT void VVexRiscv_VexRiscv___nba_sequent__TOP__VexRiscv__0(VVexRiscv_VexRiscv* vlSelf) {
    ...
    __Vtableidx34 = 0;
    QData/*55:0*/ __VdlyVal__IBusSimplePlugin_predictor_history__v0;
    __VdlyVal__IBusSimplePlugin_predictor_history__v0 = 0;
    CData/*7:0*/ __VdlyDim0__IBusSimplePlugin_predictor_history__v0;
    __VdlyDim0__IBusSimplePlugin_predictor_history__v0 = 0;
    CData/*0:0*/ __VdlySet__IBusSimplePlugin_predictor_history__v0;
    __VdlySet__IBusSimplePlugin_predictor_history__v0 = 0;
    IData/*31:0*/ __VdlyVal__RegFilePlugin_regFile__v0;
    __VdlyVal__RegFilePlugin_regFile__v0 = 0;
    CData/*4:0*/ __VdlyDim0__RegFilePlugin_regFile__v0;
    __VdlyDim0__RegFilePlugin_regFile__v0 = 0;
    CData/*0:0*/ __VdlySet__RegFilePlugin_regFile__v0;
    __VdlySet__RegFilePlugin_regFile__v0 = 0;
    QData/*32:0*/ __VdlyVal__IBusSimplePlugin_rspJoin_rspBuffer_c__DOT__fifo__DOT__logic_ram__v0;
    __VdlyVal__IBusSimplePlugin_rspJoin_rspBuffer_c__DOT__fifo__DOT__logic_ram__v0 = 0;
    CData/*0:0*/ __VdlyDim0__IBusSimplePlugin_rspJoin_rspBuffer_c__DOT__fifo__DOT__logic_ram__v0;
    __VdlyDim0__IBusSimplePlugin_rspJoin_rspBuffer_c__DOT__fifo__DOT__logic_ram__v0 = 0;
    CData/*0:0*/ __VdlySet__IBusSimplePlugin_rspJoin_rspBuffer_c__DOT__fifo__DOT__logic_ram__v0;
    __VdlySet__IBusSimplePlugin_rspJoin_rspBuffer_c__DOT__fifo__DOT__logic_ram__v0 = 0;
    // Body
    __VdlySet__RegFilePlugin_regFile__v0 = 0U;
    __VdlySet__IBusSimplePlugin_rspJoin_rspBuffer_c__DOT__fifo__DOT__logic_ram__v0 = 0U;
    __VdlySet__IBusSimplePlugin_predictor_history__v0 = 0U;
    if (vlSelfRef.__PVT___zz_1) {
        __VdlyVal__RegFilePlugin_regFile__v0 = vlSelfRef.lastStageRegFileWrite_payload_data;
        __VdlyDim0__RegFilePlugin_regFile__v0 = vlSelfRef.lastStageRegFileWrite_payload_address;
        __VdlySet__RegFilePlugin_regFile__v0 = 1U;
    }
    if (vlSelfRef.__PVT__IBusSimplePlugin_rspJoin_rspBuffer_c__DOT__fifo__DOT___zz_1) {
        __VdlyVal__IBusSimplePlugin_rspJoin_rspBuffer_c__DOT__fifo__DOT__logic_ram__v0 
            = (((QData)((IData)(vlSymsp->TOP.iBus_rsp_payload_inst)) 
                << 1U) | (QData)((IData)(vlSymsp->TOP.iBus_rsp_payload_error)));
        __VdlyDim0__IBusSimplePlugin_rspJoin_rspBuffer_c__DOT__fifo__DOT__logic_ram__v0 
            = (1U & (IData)(vlSelfRef.__PVT__IBusSimplePlugin_rspJoin_rspBuffer_c__DOT__fifo__DOT__logic_ptr_push));
        __VdlySet__IBusSimplePlugin_rspJoin_rspBuffer_c__DOT__fifo__DOT__logic_ram__v0 = 1U;
    }
    if (vlSelfRef.__PVT___zz_2) {
        __VdlyVal__IBusSimplePlugin_predictor_history__v0 
            = (((QData)((IData)(vlSelfRef.__PVT__execute_to_memory_BRANCH_CALC)) 
                << 0x18U) | (QData)((IData)((((IData)(vlSelfRef.__PVT__IBusSimplePlugin_predictor_historyWrite_payload_data_branchWish) 
                                              << 0x16U) 
                                             | (vlSelfRef.__PVT__execute_to_memory_PC 
                                                >> 0xaU)))));
        __VdlyDim0__IBusSimplePlugin_predictor_history__v0 
            = (0xffU & ((vlSelfRef.__PVT__execute_to_memory_PC 
                         >> 2U) - (IData)(1U)));
        __VdlySet__IBusSimplePlugin_predictor_history__v0 = 1U;
    }
    vlSelfRef.__PVT__RegFilePlugin_regFile_spinal_port0 
        = vlSelfRef.RegFilePlugin_regFile[(0x1fU & 
                                           (vlSelfRef.__PVT__decode_INSTRUCTION_ANTICIPATED 
                                            >> 0xfU))];
    vlSelfRef.__PVT__RegFilePlugin_regFile_spinal_port1 
        = vlSelfRef.RegFilePlugin_regFile[(0x1fU & 
                                           (vlSelfRef.__PVT__decode_INSTRUCTION_ANTICIPATED 
                                            >> 0x14U))];
    ...
    vlSelfRef.__PVT__memory_to_writeBack_MEMORY_ADDRESS_LOW 
        = vlSelfRef.__PVT__execute_to_memory_MEMORY_ADDRESS_LOW;
    ...
    if ((1U & (~ (IData)(vlSelfRef.__PVT__memory_arbitration_haltItself)))) {
        vlSelfRef.__PVT__execute_to_memory_REGFILE_WRITE_DATA 
            = vlSelfRef.__PVT___zz_decode_RS2_2;
        vlSelfRef.__PVT__execute_to_memory_IS_SPHERE_VOLUME 
            = vlSelfRef.__PVT__decode_to_execute_IS_SPHERE_VOLUME;
    ...
    if ((1U & (~ (IData)(vlSelfRef.__PVT__execute_arbitration_isStuck)))) {
        ...
        vlSelfRef.__PVT__decode_to_execute_IS_SIMD_ADD 
            = (0x4000030U == (0x4000034U & vlSelfRef.__PVT___zz_IBusSimplePlugin_injector_decodeInput_payload_rsp_inst));
        vlSelfRef.__PVT__decode_to_execute_SRC2_FORCE_ZERO 
            = ((~ (IData)(vlSelfRef.__PVT__decode_SRC_USE_SUB_LESS)) 
               & (0x24U == (0x64U & vlSelfRef.__PVT___zz_IBusSimplePlugin_injector_decodeInput_payload_rsp_inst)));
        vlSelfRef.__PVT__decode_to_execute_IS_SPHERE_VOLUME = 1U;
        vlSelfRef.__PVT__decode_to_execute_BRANCH_CTRL 
            = vlSelfRef.__PVT__decode_BRANCH_CTRL;
        vlSelfRef.__PVT__decode_to_execute_FORMAL_PC_NEXT 
            = ((IData)(4U) + vlSelfRef.__PVT___zz_IBusSimplePlugin_injector_decodeInput_payload_pc);
        vlSelfRef.__PVT__decode_to_execute_PREDICTION_CONTEXT_line_target 
            = vlSelfRef.__PVT__IBusSimplePlugin_predictor_iBusRspContextOutput_delay_1_line_target;
    }
    if ((1U & (~ (IData)(vlSelfRef.__PVT__memory_arbitration_haltItself)))) {
        vlSelfRef.__PVT__execute_to_memory_TARGET_MISSMATCH1 
            = (vlSelfRef.__PVT___zz_IBusSimplePlugin_injector_decodeInput_payload_pc 
               != (0xfffffffeU & vlSelfRef.__PVT__execute_BranchPlugin_branchAdder));
        vlSelfRef.__PVT__execute_to_memory_PREDICTION_CONTEXT_hazard 
            = vlSelfRef.__PVT__decode_to_execute_PREDICTION_CONTEXT_hazard;
    }
    if ((1U & (~ (IData)(vlSelfRef.__PVT__execute_arbitration_isStuck)))) {
        vlSelfRef.__PVT__decode_to_execute_PREDICTION_CONTEXT_hazard 
            = vlSelfRef.__PVT__IBusSimplePlugin_predictor_iBusRspContextOutput_delay_1_hazard;
    }
    if ((1U & (~ (IData)(vlSelfRef.__PVT__memory_arbitration_haltItself)))) {
        vlSelfRef.__PVT__execute_to_memory_NEXT_PC1 
            = ((IData)(4U) + vlSelfRef.__PVT__decode_to_execute_PC);
        vlSelfRef.__PVT__execute_to_memory_PREDICTION_CONTEXT_hit 
            = vlSelfRef.__PVT__decode_to_execute_PREDICTION_CONTEXT_hit;
    }
    if ((1U & (~ (IData)(vlSelfRef.__PVT__execute_arbitration_isStuck)))) {
        vlSelfRef.__PVT__decode_to_execute_PREDICTION_CONTEXT_hit 
            = vlSelfRef.__PVT__IBusSimplePlugin_predictor_iBusRspContextOutput_delay_1_hit;
    }
    if ((1U & (~ (IData)(vlSelfRef.__PVT__memory_arbitration_haltItself)))) {
        vlSelfRef.__PVT__execute_to_memory_PREDICTION_CONTEXT_line_source 
            = vlSelfRef.__PVT__decode_to_execute_PREDICTION_CONTEXT_line_source;
    }
    if ((1U & (~ (IData)(vlSelfRef.__PVT__execute_arbitration_isStuck)))) {
        vlSelfRef.__PVT__decode_to_execute_PREDICTION_CONTEXT_line_source 
            = vlSelfRef.__PVT__IBusSimplePlugin_predictor_iBusRspContextOutput_delay_1_line_source;
    }
    if ((1U & (~ (IData)(vlSelfRef.__PVT__memory_arbitration_haltItself)))) {
        vlSelfRef.__PVT__execute_to_memory_PREDICTION_CONTEXT_line_branchWish 
            = vlSelfRef.__PVT__decode_to_execute_PREDICTION_CONTEXT_line_branchWish;
    }
    if ((1U & (~ (IData)(vlSelfRef.__PVT__execute_arbitration_isStuck)))) {
        vlSelfRef.__PVT__decode_to_execute_PREDICTION_CONTEXT_line_branchWish 
            = vlSelfRef.__PVT__IBusSimplePlugin_predictor_iBusRspContextOutput_delay_1_line_branchWish;
    }
    if ((1U & (~ (IData)(vlSelfRef.__PVT__memory_arbitration_haltItself)))) {
        vlSelfRef.__PVT__execute_to_memory_MEMORY_STORE 
            = vlSelfRef.__PVT__decode_to_execute_MEMORY_STORE;
        ...
        vlSelfRef.__PVT__execute_to_memory_SPHERE_VOLUME 
            = ((IData)(0x14U) + (vlSelfRef.__PVT__decode_to_execute_SRC1 
                                 + (IData)((5ULL * (QData)((IData)(vlSelfRef.__PVT__decode_to_execute_SRC2))))));
    }
    if (vlSelfRef.__PVT__IBusSimplePlugin_iBusRsp_stages_0_input_ready) {
        vlSelfRef.__PVT__IBusSimplePlugin_predictor_writeLast_payload_data_branchWish 
            = vlSelfRef.__PVT__IBusSimplePlugin_predictor_historyWrite_payload_data_branchWish;
        vlSelfRef.__PVT__IBusSimplePlugin_predictor_buffer_pcCorrected 
            = ((IData)(vlSelfRef.__PVT__IBusSimplePlugin_fetchPc_correction) 
               | (IData)(vlSelfRef.__PVT__IBusSimplePlugin_fetchPc_correctionReg));
        vlSelfRef.__PVT__IBusSimplePlugin_predictor_writeLast_payload_data_target 
            = vlSelfRef.__PVT__execute_to_memory_BRANCH_CALC;
    }
    if ((1U & (~ (IData)(vlSelfRef.__PVT__memory_arbitration_haltItself)))) {
        vlSelfRef.__PVT__execute_to_memory_BRANCH_CALC 
            = (0xfffffffeU & vlSelfRef.__PVT__execute_BranchPlugin_branchAdder);
        vlSelfRef.__PVT__execute_to_memory_MEMORY_ADDRESS_LOW 
            = (3U & vlSelfRef.__PVT__execute_SrcPlugin_addSub);
        vlSelfRef.__PVT__execute_to_memory_REGFILE_WRITE_VALID 
    ...
    vlSelfRef.__PVT__HazardSimplePlugin_writeBackBuffer_payload_address 
        = (0x1fU & (vlSelfRef.__PVT__memory_to_writeBack_INSTRUCTION 
                    >> 7U));
    if (__VdlySet__IBusSimplePlugin_rspJoin_rspBuffer_c__DOT__fifo__DOT__logic_ram__v0) {
        vlSelfRef.__PVT__IBusSimplePlugin_rspJoin_rspBuffer_c__DOT__fifo__DOT__logic_ram[__VdlyDim0__IBusSimplePlugin_rspJoin_rspBuffer_c__DOT__fifo__DOT__logic_ram__v0] 
            = __VdlyVal__IBusSimplePlugin_rspJoin_rspBuffer_c__DOT__fifo__DOT__logic_ram__v0;
    }
    if (__VdlySet__RegFilePlugin_regFile__v0) {
        vlSelfRef.RegFilePlugin_regFile[__VdlyDim0__RegFilePlugin_regFile__v0] 
            = __VdlyVal__RegFilePlugin_regFile__v0;
    }
    ...
    if (vlSelfRef.__PVT__IBusSimplePlugin_iBusRsp_stages_0_input_ready) {
        vlSelfRef.__PVT__IBusSimplePlugin_predictor_writeLast_payload_data_source 
            = (vlSelfRef.__PVT__execute_to_memory_PC 
               >> 0xaU);
        vlSelfRef.__PVT__IBusSimplePlugin_predictor_buffer_hazard_regNextWhen 
            = ((IData)(vlSelfRef.__PVT__IBusSimplePlugin_predictor_writeLast_valid) 
               & ((IData)(vlSelfRef.__PVT__IBusSimplePlugin_predictor_writeLast_payload_address) 
                  == (0xffU & (vlSelfRef.__PVT___zz_IBusSimplePlugin_iBusRsp_stages_0_output_m2sPipe_payload 
                               >> 2U))));
        vlSelfRef.__PVT__IBusSimplePlugin_predictor_writeLast_valid 
            = vlSelfRef.__PVT__IBusSimplePlugin_predictor_historyWrite_valid;
        vlSelfRef.__PVT__IBusSimplePlugin_predictor_writeLast_payload_address 
            = (0xffU & ((vlSelfRef.__PVT__execute_to_memory_PC 
                         >> 2U) - (IData)(1U)));
    }
    if ((1U & (~ (IData)(vlSelfRef.__PVT__memory_arbitration_haltItself)))) {
    ...
    if ((1U & (~ (IData)(vlSelfRef.__PVT__execute_arbitration_isStuck)))) {
        vlSelfRef.__PVT__decode_to_execute_MEMORY_STORE 
            = (0x20U == (0x20U & vlSelfRef.__PVT___zz_IBusSimplePlugin_injector_decodeInput_payload_rsp_inst));
        vlSelfRef.__PVT__decode_to_execute_BYPASSABLE_MEMORY_STAGE 
            = (0x10U == (0x10U & vlSelfRef.__PVT___zz_IBusSimplePlugin_injector_decodeInput_payload_rsp_inst));
        vlSelfRef.__PVT__decode_to_execute_SHIFT_CTRL 
            = vlSelfRef.__PVT__decode_SHIFT_CTRL;
        vlSelfRef.__PVT__decode_to_execute_SRC1 = (
                                                   (0U 
                                                    == (IData)(vlSelfRef.__PVT__decode_SRC1_CTRL))
                                                    ? vlSelfRef.__PVT__decode_RS1
                                                    : 
                                                   ((2U 
                                                     == (IData)(vlSelfRef.__PVT__decode_SRC1_CTRL))
                                                     ? 4U
        ...
        vlSelfRef.__PVT__decode_to_execute_SRC2 = (
                                                   (0U 
                                                    == (IData)(vlSelfRef.__PVT__decode_SRC2_CTRL))
                                                    ? vlSelfRef.__PVT__decode_RS2
                                                    : 
                                                   ((1U 
                                                     == (IData)(vlSelfRef.__PVT__decode_SRC2_CTRL))
                                                     ? 
                                                    ...
                                                    ((2U 
                                                     ...
                                                     (((- (IData)(
                                                      ...
                                                      : vlSelfRef.__PVT___zz_IBusSimplePlugin_injector_decodeInput_payload_pc)));
        vlSelfRef.__PVT__decode_to_execute_REGFILE_WRITE_VALID 
            = vlSelfRef.__PVT__decode_REGFILE_WRITE_VALID;
        vlSelfRef.__PVT__decode_to_execute_MEMORY_ENABLE 
            = (0U == (0x58U & vlSelfRef.__PVT___zz_IBusSimplePlugin_injector_decodeInput_payload_rsp_inst));
        vlSelfRef.__PVT__decode_to_execute_PC = vlSelfRef.__PVT___zz_IBusSimplePlugin_injector_decodeInput_payload_pc;
        vlSelfRef.__PVT__decode_to_execute_INSTRUCTION 
            = vlSelfRef.__PVT___zz_IBusSimplePlugin_injector_decodeInput_payload_rsp_inst;
    }
    if ((1U & (~ (IData)(vlSelfRef.__PVT__decode_arbitration_isStuck)))) {
        vlSelfRef.__PVT___zz_IBusSimplePlugin_injector_decodeInput_payload_isRvc = 0U;
        vlSelfRef.__PVT___zz_IBusSimplePlugin_injector_decodeInput_payload_rsp_error 
            = vlSelfRef.__PVT__IBusSimplePlugin_rspJoin_fetchRsp_rsp_error;
        vlSelfRef.__PVT__IBusSimplePlugin_injector_formal_rawInDecode 
            = vlSelfRef.__PVT__IBusSimplePlugin_rspJoin_rspBuffer_c__DOT__fifo_io_pop_payload_inst;
        vlSelfRef.__PVT__IBusSimplePlugin_predictor_iBusRspContextOutput_delay_1_line_target 
            = vlSelfRef.__PVT__IBusSimplePlugin_predictor_iBusRspContext_line_target;
        vlSelfRef.__PVT__IBusSimplePlugin_predictor_iBusRspContextOutput_delay_1_hazard 
            = vlSelfRef.__PVT__IBusSimplePlugin_predictor_iBusRspContext_hazard;
        vlSelfRef.__PVT__IBusSimplePlugin_predictor_iBusRspContextOutput_delay_1_hit 
            = vlSelfRef.__PVT__IBusSimplePlugin_predictor_iBusRspContext_hit;
        vlSelfRef.__PVT__IBusSimplePlugin_predictor_iBusRspContextOutput_delay_1_line_source 
            = vlSelfRef.__PVT__IBusSimplePlugin_predictor_iBusRspContext_line_source;
        vlSelfRef.__PVT__IBusSimplePlugin_predictor_iBusRspContextOutput_delay_1_line_branchWish 
            = vlSelfRef.__PVT__IBusSimplePlugin_predictor_iBusRspContext_line_branchWish;
        vlSelfRef.__PVT___zz_IBusSimplePlugin_injector_decodeInput_payload_pc 
            = vlSelfRef.__PVT___zz_IBusSimplePlugin_iBusRsp_stages_1_output_m2sPipe_payload;
        vlSelfRef.__PVT___zz_IBusSimplePlugin_injector_decodeInput_payload_rsp_inst 
            = vlSelfRef.__PVT__IBusSimplePlugin_rspJoin_rspBuffer_c__DOT__fifo_io_pop_payload_inst;
    }
    vlSelfRef.__PVT__IBusSimplePlugin_predictor_historyWrite_payload_data_branchWish 
        = (3U & ((IData)(vlSelfRef.__PVT__memory_BranchPlugin_predictionMissmatch)
                  ? ((IData)(vlSelfRef.__PVT__execute_to_memory_PREDICTION_CONTEXT_hit)
                      ? (((IData)(vlSelfRef.__PVT__execute_to_memory_PREDICTION_CONTEXT_line_branchWish) 
    ...
    vlSelfRef.__PVT__execute_SRC_LESS = (1U & (((vlSelfRef.__PVT__decode_to_execute_SRC1 
                                                ...
                                                : ((IData)(vlSelfRef.__PVT__decode_to_execute_SRC_LESS_UNSIGNED)
                                                   ...
                                                   (vlSelfRef.__PVT__decode_to_execute_SRC1 
                                                    >> 0x1fU))));
    if (vlSelfRef.__PVT__IBusSimplePlugin_iBusRsp_stages_1_output_ready) {
        vlSelfRef.__PVT__IBusSimplePlugin_predictor_iBusRspContext_line_target 
            = vlSelfRef.__PVT__IBusSimplePlugin_predictor_line_target;
        vlSelfRef.__PVT__IBusSimplePlugin_predictor_iBusRspContext_hazard 
        ...
        vlSelfRef.__PVT__IBusSimplePlugin_predictor_iBusRspContext_line_branchWish 
            = vlSelfRef.__PVT__IBusSimplePlugin_predictor_line_branchWish;
        vlSelfRef.__PVT___zz_IBusSimplePlugin_iBusRsp_stages_1_output_m2sPipe_payload 
            = vlSelfRef.__PVT___zz_IBusSimplePlugin_iBusRsp_stages_0_output_m2sPipe_payload;
    }
    if (vlSelfRef.__PVT__IBusSimplePlugin_iBusRsp_stages_0_input_ready) {
        vlSelfRef.__PVT__IBusSimplePlugin_predictor_line_target 
            = (IData)((vlSelfRef.__PVT__IBusSimplePlugin_predictor_history_spinal_port1 
                       >> 0x18U));
        vlSelfRef.__PVT__IBusSimplePlugin_predictor_line_source 
            = (0x3fffffU & (IData)(vlSelfRef.__PVT__IBusSimplePlugin_predictor_history_spinal_port1));
        vlSelfRef.__PVT__IBusSimplePlugin_predictor_line_branchWish 
            = (3U & (IData)((vlSelfRef.__PVT__IBusSimplePlugin_predictor_history_spinal_port1 
                             >> 0x16U)));
        vlSelfRef.__PVT__IBusSimplePlugin_predictor_history_spinal_port1 
            = vlSelfRef.__PVT__IBusSimplePlugin_predictor_history
            [(0xffU & (vlSelfRef.__PVT__IBusSimplePlugin_fetchPc_pc 
                       >> 2U))];
        vlSelfRef.__PVT___zz_IBusSimplePlugin_iBusRsp_stages_0_output_m2sPipe_payload 
            = vlSelfRef.__PVT__IBusSimplePlugin_fetchPc_pc;
    }
    ...
    vlSelfRef.__PVT__when_HazardSimplePlugin_l48_2 
        = ((0x1fU & (vlSelfRef.__PVT__decode_to_execute_INSTRUCTION 
                     >> 7U)) == (0x1fU & (vlSelfRef.__PVT___zz_IBusSimplePlugin_injector_decodeInput_payload_rsp_inst 
                                          >> 0xfU)));
    if (__VdlySet__IBusSimplePlugin_predictor_history__v0) {
        vlSelfRef.__PVT__IBusSimplePlugin_predictor_history[__VdlyDim0__IBusSimplePlugin_predictor_history__v0] 
            = __VdlyVal__IBusSimplePlugin_predictor_history__v0;
    }
...
VL_INLINE_OPT void VVexRiscv_VexRiscv___nba_sequent__TOP__VexRiscv__1(VVexRiscv_VexRiscv* vlSelf) {
    ...
    CData/*1:0*/ __Vdly__IBusSimplePlugin_rspJoin_rspBuffer_c__DOT__fifo__DOT__logic_ptr_push;
    __Vdly__IBusSimplePlugin_rspJoin_rspBuffer_c__DOT__fifo__DOT__logic_ptr_push = 0;
    CData/*1:0*/ __Vdly__IBusSimplePlugin_rspJoin_rspBuffer_c__DOT__fifo__DOT__logic_ptr_pop;
    __Vdly__IBusSimplePlugin_rspJoin_rspBuffer_c__DOT__fifo__DOT__logic_ptr_pop = 0;
    // Body
    __Vdly__IBusSimplePlugin_rspJoin_rspBuffer_discardCounter 
        = vlSelfRef.__PVT__IBusSimplePlugin_rspJoin_rspBuffer_discardCounter;
    __Vdly__IBusSimplePlugin_rspJoin_rspBuffer_c__DOT__fifo__DOT__logic_ptr_push 
        = vlSelfRef.__PVT__IBusSimplePlugin_rspJoin_rspBuffer_c__DOT__fifo__DOT__logic_ptr_push;
    __Vdly__IBusSimplePlugin_rspJoin_rspBuffer_c__DOT__fifo__DOT__logic_ptr_pop 
        = vlSelfRef.__PVT__IBusSimplePlugin_rspJoin_rspBuffer_c__DOT__fifo__DOT__logic_ptr_pop;
    if (vlSymsp->TOP.reset) {
        __Vdly__IBusSimplePlugin_rspJoin_rspBuffer_discardCounter = 0U;
        __Vdly__IBusSimplePlugin_rspJoin_rspBuffer_c__DOT__fifo__DOT__logic_ptr_push = 0U;
        __Vdly__IBusSimplePlugin_rspJoin_rspBuffer_c__DOT__fifo__DOT__logic_ptr_pop = 0U;
        vlSelfRef.__PVT__IBusSimplePlugin_rspJoin_rspBuffer_c__DOT__fifo__DOT__logic_ptr_wentUp = 0U;
        vlSelfRef.__PVT__IBusSimplePlugin_pending_value = 0U;
        vlSelfRef.__PVT__IBusSimplePlugin_cmdFork_cmdKeep = 0U;
        vlSelfRef.__PVT__IBusSimplePlugin_cmdFork_cmdFired = 0U;
        vlSelfRef.__PVT__IBusSimplePlugin_fetchPc_inc = 0U;
        vlSelfRef.IBusSimplePlugin_fetchPc_pcReg = 0x80000000U;
        vlSelfRef.__PVT___zz_IBusSimplePlugin_iBusRsp_stages_1_output_m2sPipe_valid = 0U;
        vlSelfRef.__PVT__IBusSimplePlugin_injector_nextPcCalc_valids_5 = 0U;
        vlSelfRef.__PVT__writeBack_arbitration_isValid = 0U;
        vlSelfRef.__PVT__IBusSimplePlugin_fetchPc_correctionReg = 0U;
        vlSelfRef.__PVT___zz_IBusSimplePlugin_iBusRsp_stages_0_output_m2sPipe_valid = 0U;
        vlSelfRef.__PVT__IBusSimplePlugin_injector_nextPcCalc_valids_4 = 0U;
        vlSelfRef.__PVT__memory_arbitration_isValid = 0U;
        vlSelfRef.__PVT__IBusSimplePlugin_injector_nextPcCalc_valids_3 = 0U;
        vlSelfRef.__PVT__execute_arbitration_isValid = 0U;
        vlSelfRef.__PVT__IBusSimplePlugin_injector_nextPcCalc_valids_2 = 0U;
        vlSelfRef.__PVT___zz_IBusSimplePlugin_injector_decodeInput_valid = 0U;
        vlSelfRef.__PVT__IBusSimplePlugin_injector_nextPcCalc_valids_1 = 0U;
        vlSelfRef.__PVT__IBusSimplePlugin_injector_nextPcCalc_valids_0 = 0U;
        vlSelfRef.__PVT___zz_8 = 1U;
    } else {
        __Vdly__IBusSimplePlugin_rspJoin_rspBuffer_discardCounter 
            = (7U & ((IData)(vlSelfRef.__PVT__IBusSimplePlugin_rspJoin_rspBuffer_discardCounter) 
                     - (IData)(vlSelfRef.__PVT___zz_IBusSimplePlugin_rspJoin_rspBuffer_discardCounter_1)));
        if (vlSelfRef.__PVT__IBusSimplePlugin_rspJoin_rspBuffer_c__DOT__fifo__DOT__logic_ptr_doPush) {
            __Vdly__IBusSimplePlugin_rspJoin_rspBuffer_c__DOT__fifo__DOT__logic_ptr_push 
                = (3U & ((IData)(1U) + (IData)(vlSelfRef.__PVT__IBusSimplePlugin_rspJoin_rspBuffer_c__DOT__fifo__DOT__logic_ptr_push)));
        }
        if (vlSelfRef.__PVT__IBusSimplePlugin_rspJoin_rspBuffer_c__DOT__fifo__DOT__logic_ptr_doPop) {
            __Vdly__IBusSimplePlugin_rspJoin_rspBuffer_c__DOT__fifo__DOT__logic_ptr_pop 
                = (3U & ((IData)(1U) + (IData)(vlSelfRef.__PVT__IBusSimplePlugin_rspJoin_rspBuffer_c__DOT__fifo__DOT__logic_ptr_pop)));
        }
        if (((IData)(vlSelfRef.__PVT__IBusSimplePlugin_rspJoin_rspBuffer_c__DOT__fifo__DOT__logic_ptr_doPush) 
             != (IData)(vlSelfRef.__PVT__IBusSimplePlugin_rspJoin_rspBuffer_c__DOT__fifo__DOT__logic_ptr_doPop))) {
            vlSelfRef.__PVT__IBusSimplePlugin_rspJoin_rspBuffer_c__DOT__fifo__DOT__logic_ptr_wentUp 
                = vlSelfRef.__PVT__IBusSimplePlugin_rspJoin_rspBuffer_c__DOT__fifo__DOT__logic_ptr_doPush;
        }
        vlSelfRef.__PVT__IBusSimplePlugin_pending_value 
            = vlSelfRef.__PVT__IBusSimplePlugin_pending_next;
        if (vlSelfRef.__PVT__IBusSimplePlugin_cmdFork_enterTheMarket) {
            vlSelfRef.__PVT__IBusSimplePlugin_cmdFork_cmdKeep = 1U;
        }
        if (vlSymsp->TOP.iBus_cmd_ready) {
            vlSelfRef.__PVT__IBusSimplePlugin_cmdFork_cmdKeep = 0U;
        }
        if (((IData)(vlSelfRef.iBus_cmd_valid) & (IData)(vlSymsp->TOP.iBus_cmd_ready))) {
            vlSelfRef.__PVT__IBusSimplePlugin_cmdFork_cmdFired = 1U;
        }
        if (vlSelfRef.__PVT__IBusSimplePlugin_fetchPc_correction) {
            vlSelfRef.__PVT__IBusSimplePlugin_fetchPc_inc = 0U;
            vlSelfRef.__PVT__IBusSimplePlugin_fetchPc_correctionReg = 1U;
        }
        if (vlSelfRef.__PVT__IBusSimplePlugin_fetchPc_output_fire) {
            vlSelfRef.__PVT__IBusSimplePlugin_fetchPc_inc = 1U;
            vlSelfRef.__PVT__IBusSimplePlugin_fetchPc_correctionReg = 0U;
        }
        if (((~ (IData)(vlSelfRef.__PVT__IBusSimplePlugin_fetchPc_booted)) 
             & (IData)(vlSelfRef.__PVT__IBusSimplePlugin_iBusRsp_stages_0_input_ready))) {
            vlSelfRef.__PVT__IBusSimplePlugin_fetchPc_inc = 0U;
        }
        if (((IData)(vlSelfRef.__PVT__IBusSimplePlugin_fetchPc_booted) 
        ...
        if (vlSelfRef.__PVT__IBusSimplePlugin_iBusRsp_stages_1_output_ready) {
            vlSelfRef.__PVT___zz_IBusSimplePlugin_iBusRsp_stages_1_output_m2sPipe_valid 
                = (((~ (IData)(vlSelfRef.__PVT__IBusSimplePlugin_iBusRsp_stages_1_halt)) 
        ...
        if (vlSelfRef.__PVT__IBusSimplePlugin_fetchPc_flushed) {
            vlSelfRef.__PVT__IBusSimplePlugin_injector_nextPcCalc_valids_5 = 0U;
        }
        vlSelfRef.__PVT__IBusSimplePlugin_injector_nextPcCalc_valids_5 
            = vlSelfRef.__PVT__IBusSimplePlugin_injector_nextPcCalc_valids_4;
        vlSelfRef.__PVT__writeBack_arbitration_isValid = 0U;
        if ((1U & (~ (IData)(vlSelfRef.__PVT__memory_arbitration_haltItself)))) {
        ...
        if ((1U & (~ (IData)(vlSelfRef.__PVT__memory_arbitration_haltItself)))) {
            vlSelfRef.__PVT__IBusSimplePlugin_injector_nextPcCalc_valids_4 
                = vlSelfRef.__PVT__IBusSimplePlugin_injector_nextPcCalc_valids_3;
            vlSelfRef.__PVT__memory_arbitration_isValid = 0U;
        }
        if ((1U & ((~ (IData)(vlSelfRef.__PVT__execute_arbitration_isStuck)) 
        ...
        if ((1U & (~ (IData)(vlSelfRef.__PVT__execute_arbitration_isStuck)))) {
            vlSelfRef.__PVT__IBusSimplePlugin_injector_nextPcCalc_valids_3 
                = vlSelfRef.__PVT__IBusSimplePlugin_injector_nextPcCalc_valids_2;
        }
        if ((1U & ((~ (IData)(vlSelfRef.__PVT__execute_arbitration_isStuck)) 
                   | (IData)(vlSelfRef.__PVT__execute_arbitration_removeIt)))) {
            vlSelfRef.__PVT__execute_arbitration_isValid = 0U;
        ...
        if ((1U & ((~ (IData)(vlSelfRef.__PVT__decode_arbitration_isStuck)) 
            ...
            vlSelfRef.__PVT__execute_arbitration_isValid 
                = vlSelfRef.__PVT___zz_IBusSimplePlugin_injector_decodeInput_valid;
        }
        if (vlSelfRef.__PVT__IBusSimplePlugin_fetchPc_flushed) {
            vlSelfRef.__PVT__IBusSimplePlugin_injector_nextPcCalc_valids_3 = 0U;
            vlSelfRef.__PVT__IBusSimplePlugin_injector_nextPcCalc_valids_2 = 0U;
        ...
        if ((1U & (~ (IData)(vlSelfRef.__PVT__decode_arbitration_isStuck)))) {
            vlSelfRef.__PVT__IBusSimplePlugin_injector_nextPcCalc_valids_2 
                = vlSelfRef.__PVT__IBusSimplePlugin_injector_nextPcCalc_valids_1;
        }
        if (vlSelfRef.__PVT__IBusSimplePlugin_fetchPc_flushed) {
            vlSelfRef.__PVT__IBusSimplePlugin_injector_nextPcCalc_valids_2 = 0U;
            vlSelfRef.__PVT__IBusSimplePlugin_injector_nextPcCalc_valids_1 = 0U;
        ...
        if (vlSelfRef.__PVT__IBusSimplePlugin_iBusRsp_stages_1_output_ready) {
            vlSelfRef.__PVT__IBusSimplePlugin_injector_nextPcCalc_valids_1 
                = vlSelfRef.__PVT__IBusSimplePlugin_injector_nextPcCalc_valids_0;
        }
        if (vlSelfRef.__PVT__IBusSimplePlugin_fetchPc_flushed) {
            vlSelfRef.__PVT__IBusSimplePlugin_injector_nextPcCalc_valids_1 = 0U;
            vlSelfRef.__PVT__IBusSimplePlugin_injector_nextPcCalc_valids_0 = 0U;
        ...
        if (vlSelfRef.__PVT__IBusSimplePlugin_iBusRsp_stages_0_input_ready) {
            vlSelfRef.__PVT__IBusSimplePlugin_cmdFork_cmdFired = 0U;
            vlSelfRef.__PVT___zz_IBusSimplePlugin_iBusRsp_stages_0_output_m2sPipe_valid 
                = vlSelfRef.__PVT__IBusSimplePlugin_fetchPc_booted;
            vlSelfRef.__PVT__IBusSimplePlugin_injector_nextPcCalc_valids_0 = 1U;
        }
        if (vlSelfRef.__PVT__decode_arbitration_removeIt) {
            vlSelfRef.__PVT___zz_IBusSimplePlugin_injector_decodeInput_valid = 0U;
        }
        if ((1U & (~ (IData)(vlSelfRef.__PVT__decode_arbitration_isStuck)))) {
            vlSelfRef.__PVT___zz_IBusSimplePlugin_injector_decodeInput_valid 
        ...
        vlSelfRef.__PVT___zz_8 = 0U;
    }
    vlSelfRef.__PVT__HazardSimplePlugin_writeBackBuffer_valid 
        = ((1U & (~ (IData)(vlSymsp->TOP.reset))) && (IData)(vlSelfRef.__PVT__HazardSimplePlugin_writeBackWrites_valid));
    vlSelfRef.__PVT__IBusSimplePlugin_rspJoin_rspBuffer_discardCounter 
        = __Vdly__IBusSimplePlugin_rspJoin_rspBuffer_discardCounter;
    vlSelfRef.__PVT__IBusSimplePlugin_rspJoin_rspBuffer_c__DOT__fifo__DOT__logic_ptr_push 
        = __Vdly__IBusSimplePlugin_rspJoin_rspBuffer_c__DOT__fifo__DOT__logic_ptr_push;
...
VL_INLINE_OPT void VVexRiscv_VexRiscv___nba_comb__TOP__VexRiscv__0(VVexRiscv_VexRiscv* vlSelf) {
    ...
    if (vlSelfRef.__PVT__memory_arbitration_isValid) {
        ...
        vlSelfRef.__PVT__when_HazardSimplePlugin_l45_1 = 0U;
    }
    vlSelfRef.__PVT__memory_arbitration_haltItself = 0U;
    if (((IData)(vlSelfRef.__PVT__execute_to_memory_MEMORY_ENABLE) 
         & ((~ ((IData)(vlSymsp->TOP.dBus_rsp_ready) 
